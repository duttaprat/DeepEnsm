...
class ZDT(Problem):
    ...
    def __dominates(self, individual2, individual1):
        worse_than_other = individual1.objectives[0] >= individual2.objectives[0] and individual1.objectives[1] >= individual2.objectives[1] and individual1.objectives[2] >= individual2.objectives[2]
        better_than_other = individual1.objectives[0] > individual2.objectives[0] or individual1.objectives[1] > individual2.objectives[1] or individual1.objectives[2] > individual2.objectives[2]
