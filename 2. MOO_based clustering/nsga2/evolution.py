...
class Evolution(object):
    ...
    def __init__(self, problem, num_of_generations, num_of_individuals, individual_list,individual_len):
        self.utils = NSGA2Utils(problem, num_of_individuals, individual_list,individual_len)
